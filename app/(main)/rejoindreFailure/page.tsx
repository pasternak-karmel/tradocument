        ...
        <Card className="bg-white shadow-xl">
          ...
          <CardContent>
            <p className="text-center text-gray-600 mb-6">
              Nous sommes désolés, mais une erreur s'est produite lors de l'envoi de votre demande. Veuillez réessayer ou contacter notre support si le problème persiste.
            </p>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <Link href="/">
                <Button variant="outline" className="w-full py-2 rounded-full flex items-center justify-center">
                  Retour à l'accueil
