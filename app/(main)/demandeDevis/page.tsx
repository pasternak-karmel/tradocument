...
//                               <Input placeholder="Votre numéro (Ex: +33 XXX-XXX-XXX)" {...field} />
//                             </div>
//                           </FormControl>
//                           <FormMessage />
//                         </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange}>
                          ...
                          <SelectContent>
                            <SelectItem value="legal">Actes d'état civil</SelectItem>
                            <SelectItem value="medical">Affaires & Business</SelectItem>
                            <SelectItem value="technical">Diplômes & Bulletins</SelectItem>
                            <SelectItem value="financial">Finance & Commerciale</SelectItem>
                            <SelectItem value="juridique">Juridique</SelectItem>
                            <SelectItem value="permis">Permis de Conduire</SelectItem>
                            <SelectItem value="technique">Technique</SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Informations supplémentaires</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Ajoutez des détails supplémentaires sur votre demande." {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
...
<div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setShowDeliveryAddress(checked)}
                    />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Adresse d'expédition" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
