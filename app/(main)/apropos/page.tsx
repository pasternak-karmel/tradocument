      ...
      >
        ...
        >
          <div className="m-3 flex-1">
            ...
            <p className="text-gray-700 mb-4">
              La traduction assermentée, ou traduction certifiée, est un type
              de traduction réalisé par un expert-traducteur assermenté auprès
              d&apos;une Cour d&apos;Appel ou, dans certaines conditions, par
              un traducteur assermenté auprès d&apos;un TGI en fonction du
              pays de destination du document certifié.
            </p>
            <p className="text-gray-700 mb-4">
              L&apos;expert-traducteur assermenté est une personne physique
              inscrite sur une liste d&apos;experts judiciaires établie par
              une commission spéciale qui siège, en général une fois par an,
              dans les Cours d&apos;Appels. Le traducteur assermenté établi
              par le Procureur de la République de chaque Tribunal de Grande
              Instance.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              ...
              adaptées à un domaine particulier. Tradocument.com travaille
              avec plusieurs traducteurs assermentés en langues maternelles,
              très expérimentés dans leurs domaines de spécialisation
              respectifs. Nous traduisons et certifions vos documents
              officiels.
            </p>
          </div>
        ...
        >
          ...
          <div className="m-3 flex-1">
            ...
            <p className="text-gray-700 mb-4">
              La traduction assermentée, ou traduction certifiée, est un type
              de traduction réalisé par un expert-traducteur...
            </p>
            <p className="text-gray-700">
              ...
              qui est d&ap;environ mettre la fourchette des prix du …aupar
              page, les services officiels sont facturés
            </p>
          </div>
        </motion.section>
