...
const teamMembers = [
  ...
  { name: "Thomas Dubois", role: "Directeur Technique", image: "/placeholder.svg?height=100&width=100" },
  { name: "Emma Leroy", role: "Responsable des Opérations", image: "/placeholder.svg?height=100&width=100" },
  { name: "Lucas Petit", role: "Chef de Projet", image: "/placeholder.svg?height=100&width=100" },
]

const values = [
  { icon: CheckCircle, title: "Qualité", description: "Nous nous engageons à fournir des traductions de la plus haute qualité." },
  { icon: Users, title: "Collaboration", description: "Nous travaillons en étroite collaboration avec nos clients et nos traducteurs." },
  { icon: Target, title: "Précision", description: "Nous visons la précision dans chaque mot que nous traduisons." },
  { icon: Lightbulb, title: "Innovation", description: "Nous adoptons les dernières technologies pour améliorer nos services." },
]
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-gray-600 dark:text-gray-300">
                Chez TraDocument, notre mission est de briser les barrières linguistiques et de faciliter la communication mondiale. Nous nous efforçons de fournir des traductions précises, culturellement appropriées et rapides, permettant à nos clients de se connecter efficacement avec leur public international.
              </p>
            </CardContent>
          </Card>
        </motion.section>
