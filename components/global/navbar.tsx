...
//       {/* Navigation Desktop */}
//       <nav className="hidden md:flex justify-center items-center">
//         <ul className="flex items-center list-none gap-6"> {/* Centrer et espacer les éléments */}
//           <li className="text-white hover:text-[#F49C60] duration-500">
//             <Link href="/">Accueil</Link>
//           </li>
//           <li className="text-white hover:text-[#F49C60] duration-500">
...
//           </li>
//           <li className="text-white hover:text-[#F49C60] duration-500">
//             <Link href="/procuration">Procuration</Link> {/* Nouveau lien vers "Procuration" */}
//           </li>
//           <li className="text-white hover:text-[#F49C60] duration-500">
//             <Link href="/contact">Contact</Link>
//           </li>
...
//       {menuOpen && (
//         <nav
//           className="md:hidden absolute top-16 left-0 w-full bg-black/90 backdrop-blur-md p-6 flex flex-col items-center space-y-4 z-[99] transition-all duration-300 ease-in-out" // Centrer les éléments du menu mobile
//         >
//           <ul className="flex flex-col items-center list-none space-y-4">
//             <li className="text-white text-lg">
//               <Link href="/" onClick={() => setMenuOpen(false)}>Accueil</Link>
//             </li>
//             <li className="text-white text-lg">
...
//             </li>
//             <li className="text-white text-lg">
//               <Link href="/procuration" onClick={() => setMenuOpen(false)}>Procuration</Link> {/* Nouveau lien pour mobile */}
//             </li>
//             <li className="text-white text-lg">
//               <Link href="/contact" onClick={() => setMenuOpen(false)}>Contact</Link>
//             </li>
